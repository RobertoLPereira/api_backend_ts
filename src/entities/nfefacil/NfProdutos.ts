...
@Index("nfprod_pkey", ["empresa", "item", "pedido"], { unique: true })
@Entity("nf_produtos", { schema: "nfefacil" })
export class NfProdutos {
  ...
  @Column("character", { name: "cod_interno", nullable: true, length: 14 })
